...
export function Home() {
  ...
  const [mostrarResultando, setMostrarResultado] = useState(false)
  ...
  return (
    mostrarResultando === false ? (
      <CardContainer>
        ...
        <p>Conte-nos como foi nossa ajuda com sua solicitação. Agradecemos mutio seu feedback podermos melhorar nosso atendimento!</p>
